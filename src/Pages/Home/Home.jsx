    ...
    return (
        <div className='mt-36 sm:mt-0 w-screen flex place-content-center text-center'>
            <div className=' w-11/12 sm:w-1/2'>
                ...
                <div className='py-10 text-4xl font-bold text-slate-200'>Shorten, Share, and Track your URL's effortlessly.</div>
                ...
                <div className='flex justify-center gap-8 p-4 mt-4'>
